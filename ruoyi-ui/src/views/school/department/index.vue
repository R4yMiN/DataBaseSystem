<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['school:department:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['school:department:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['school:department:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['school:department:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="departmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="联系电话" align="center" prop="phoneCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="院系号" prop="deptId">
          <el-input v-model="form.deptId" placeholder="请输入院系号" :disabled="title.includes('修改')" />
        </el-form-item>
...
<script>
import { listDepartment, getDepartment, delDepartment, addDepartment, updateDepartment } from "@/api/school/department"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        deptId: [
          { required: true, message: "院系号不能为空", trigger: "blur" }
        ],
        deptName: [
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('school/department/export', {
        ...this.queryParams
