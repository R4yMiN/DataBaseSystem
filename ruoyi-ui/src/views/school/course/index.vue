<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="课名" prop="courseName">
        <el-input
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课名" align="center" prop="courseName" />
      <el-table-column label="学分" align="center" prop="credit" />
      <el-table-column label="学时" align="center" prop="creditHours" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="课程号" prop="courseId">
          <el-input v-model="form.courseId" placeholder="请输入课程号" :disabled="title.indexOf('修改') !== -1" />
        </el-form-item>
        <el-form-item label="课名" prop="courseName">
          <el-input v-model="form.courseName" placeholder="请输入课名" />
        </el-form-item>
        <el-form-item label="学分" prop="credit">
          <el-input v-model="form.credit" placeholder="请输入学分" />
        </el-form-item>
        <el-form-item label="学时" prop="creditHours">
          <el-input v-model="form.creditHours" placeholder="请输入学时" />
        </el-form-item>
        <el-form-item label="院系号" prop="deptId">
...
<script>
import { listCourse, getCourse, delCourse, addCourse, updateCourse } from "@/api/school/course"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('school/course/export', {
        ...this.queryParams
